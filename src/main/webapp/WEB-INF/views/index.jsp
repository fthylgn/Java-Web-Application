...
<%@ include file="common/navigation.jspf"%>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="./resources/images/header-smartphone.png" alt="alternative">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="./resources/images/features-icon-1.svg" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="./resources/images/features-icon-2.svg" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="./resources/images/features-icon-3.svg" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="./resources/images/features-icon-4.svg" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="./resources/images/features-icon-5.svg" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="./resources/images/features-icon-6.svg" alt="alternative">
                        </div>
                        <div class="card-body">
    ...
    <div id="details" class="basic-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="./resources/images/details-1.jpg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div class="basic-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="./resources/images/details-2.jpg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-5">
                    <div class="text-container">
	...
	<div id="details-lightbox" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
			...
			<div class="col-lg-8">
                <div class="image-container">
                    <img class="img-fluid" src="./resources/images/details-lightbox.jpg" alt="alternative">
                </div> <!-- end of image-container -->
			</div> <!-- end of col -->
			<div class="col-lg-4">
                <h3>Goals Setting</h3>
    ...
    <div class="basic-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="./resources/images/details-3.jpg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div id="download" class="basic-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="./resources/images/conclusion-smartphone.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
